...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center bg-dark-gradient hero-grid overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-20 w-full">
        <div className="relative rounded-lg p-8 md:p-12 lg:p-16 max-w-4xl mx-auto border border-amber/20 shadow-amber">
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl uppercase leading-[1.05] tracking-wide text-white text-center">
            {words.map((word, i) => (
              <motion.span
                key={i}
        ...
        <motion.p
          ...
          className="mt-8 text-center text-white/60 text-lg max-w-2xl mx-auto leading-relaxed"
        >
      ...
      <div className="relative border-t border-white/5 bg-night/50 backdrop-blur-sm">
